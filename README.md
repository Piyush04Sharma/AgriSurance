🌾 AgriSurance
Crop Insurance Management Platform

AgriSurance is a full-stack MERN web application that digitizes the crop insurance process by connecting farmers with insurance providers through a secure and user-friendly platform. The system enables farmers to enroll in insurance policies, submit crop damage claims digitally, and track claim approval and payout status in real time.
